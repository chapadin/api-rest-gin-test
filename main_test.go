...
func CriaAlunoMock() {
	aluno := models.Aluno{Nome: "Nome do alunto teste", CPF: "12345678900", RG: "123456789"}
...
func TestBuscaAlunoPorIdHandler(t *testing.T) {
	...
	assert.Equal(t, "Nome do alunto teste", alunoMock.Nome)
...
func TestEditaAlunoHandler(t *testing.T) {
	...
	aluno := models.Aluno{Nome: "Nome do alunto teste", CPF: "47123456789", RG: "123456700"}
	...
	assert.Equal(t, "Nome do alunto teste", alunoMockAtualizado.Nome)
}
